...
(This specific painitng is sound reactive (viewer needs to yell really hard for the full effect). The solid red dot in the middle will appear with small volume, The CMY dots need far more volume to 'grow'. As a 'reward' for the viewer the CMY colors will mix when the 'grow' to a size that they overlap things)
